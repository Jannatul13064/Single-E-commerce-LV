...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('dashboard_asset/assets') }}" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Core CSS -->
    {{-- <link rel="stylesheet"
        href="{{ asset('dashboard_asset/assets/vendor/css/core.css" class="template-customizer-core-css') }}" />
    <link rel="stylesheet"
        href="{{ asset('dashboard_asset/assets/vendor/css/theme-default.css" class="template-customizer-theme-css') }}" />
    <link rel="stylesheet" href="{{ asset('dashboard_asset/assets/css/demo.css') }}" /> --}}
    <link rel="stylesheet" href="{{ asset('dashboard_asset/assets/vendor/css/core.css') }}" />




    <link rel="stylesheet" href="{{ asset('dashboard_asset/assets/vendor/css/theme-default.css') }}" />
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('admindashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercas">BazarGrab</span>
                    </a>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3">
                                <a class="github-button" href="_blank" data-icon="locticon-star" data-size="large"
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="{{ asset('dashboard_asset/assets/img/avatars/1.png') }}"
