            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="subcategory_name" name="product_name"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="subcategory_name" name="product_price"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="subcategory_name" name="product_quantity"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="" id="" cols="30" rows="10" style="height:69px"></textarea>
                        </div>
