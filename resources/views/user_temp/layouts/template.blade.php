@php
    $categories = App\Models\Category::latest()->get(); //fetch the category data
@endphp
...
<html lang="en">
   <head>
      ...
      <link rel="stylesoeet" href="{{asset('frontend_asset/css/owl.theme.default.min.css')}}">
            ...
            <div class="container">
               <div class="containt_main">
                 ...
                 {{-- //Sidebar categories --}}
                  ...
                  <span class="toggle_icon" onclick="openNav()"><img src="{{asset('frontend_asset/images/toggle-icon.png')}}"></span>
                  <div class="dropdown">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="{{asset('frontend_asset/images/flag-uk.png')}}" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="{{asset('frontend_asset/images/flag-france.png')}}" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
